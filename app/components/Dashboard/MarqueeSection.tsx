...
const MarqueeSection: React.FC = () => {
    ...
    return (
        <section className="content-visibility-auto text-neutral-dark mt-24 relative lg:-left-16 flex w-[90%] xl:w-[80%] lg:w-[90%] xl:w-[80%] justify-center items-center mx-auto">
            {/* Left Marquee */}
